...
*   **SSO & Email Integration:** 🔐
    ...
    *   **Email-to-Task Mastery:**
        ...
        *   **Separation of Content & Summary:** Email-generated tasks store the complete raw email content in the task's **Description**, while saving the AI-extracted actionable insights directly into the **AI Summary** field (`IssueSummary`). Existing email tasks can be backfilled using `scripts/backfill_email_tasks.py`.
